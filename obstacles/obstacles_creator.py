...
# this file creates obstacles according to a grid size

# returns a new obstacle cell
...
# this function checks that the graph in fully connected when a new cell become an obstacle
# the function runs STC and sees if all vertices can be covered
def check_the_graph_is_fully_connected_with_the_new_cell(obstacles_list, cell, grid_size):
    ...
    # if all cells covered, the graph is fully connected
...
if __name__ == '__main__':
    grid_size = 10
    obstacles_list = []
    # this while loop makes obstacles until we reach the number of obstacles we need
    ...
    # save into a file the obstacles
